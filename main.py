...
async def on_message(message):
    ...
    #webhooks
        ...
        async with message.channel.typing():
            await message.channel.send(
                file=await countInfo.get_img(client, message))

    elif message.content.lower().startswith("!countall"):
        async with message.channel.typing():
            await message.reply(await countInfo.get_countAll(client, message),
                                mention_author=True)

    elif message.content.lower().startswith("!count"):
        async with message.channel.typing():
            await message.reply(await
                                countInfo.get_count(message.content[7:],
                                                    client, message),
                                mention_author=True)

    elif message.content.lower().startswith("!wordcountchannel"):
        async with message.channel.typing():
            await message.reply(await countInfo.get_wordchannel(
                message.content[18:], client, message),
                                mention_author=True)
        ...
        async with message.channel.typing():
            await message.channel.send(
                file=await countInfo.get_wordImg(client, message))

    elif message.content.lower().startswith("!wordcountall"):
        async with message.channel.typing():
            await message.reply(await
                                countInfo.get_wordCountAll(client, message),
                                mention_author=True)

    elif message.content.lower().startswith("!wordcount"):
        async with message.channel.typing():
            await message.reply(await countInfo.get_wordCount(
                message.content[11:], client, message),
                                mention_author=True)
        ...
        async with message.channel.typing():
            await message.channel.send(
                "https://github.com/591291-hvl/dpsharkBot")

    elif message.content.lower().startswith("jeg er"):
        async with message.channel.typing():
            await message.channel.send("Hei " + message.content[7:] +
                                       ", jeg er dpsharkBot")
        ...
        async with message.channel.typing():
            ...
            if value == 0:
                ...
                await message.channel.send(
                    file=discord.File('other/sleep1.jpg'))

    elif "this is fine" in message.content.lower():
        async with message.channel.typing():
            await message.channel.send(
                file=discord.File('other/thisisfine.jpg'))
    ...
    #	print("Done")
        ...
        async with message.channel.typing():
            diffusion.wrapper(message.content[7:])
            await message.reply(file=discord.File('other/newImage.png'))

    #"main" function of bot
    elif "weed" in message.content.lower().replace(
            " ",
            "") and not "milkweed" in message.content.lower().replace(" ", ""):
        async with message.channel.typing():
